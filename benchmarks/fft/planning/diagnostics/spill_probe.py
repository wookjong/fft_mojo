...
from planning.search.fft_cost_model import CostWeights, DEFAULT_COST_WEIGHTS, PlanMetrics, estimate_cost
...
def probe_persistent_kernel_spill_free(
    ...
    *,
    ...
    `plan` (from `planning.execution.fft_plan_persistent.make_persistent_leaf_plan`)
...
def probe_and_rerank_candidates(
    ...
    *fastest* one on real hardware among however many candidates exist
    ...
    """
    from planning.search.fft_plan_search import rank_candidates
