...
struct FFTFP32Kernel0(NDPTask):
    ...
    def stage_0():
        ...
        if True:  # batch 1 scope
            ...
            var rr0_lane0 = p.input_real_base.load[width=1](in_batch_base + 60)
            var ii0_lane0 = p.input_imag_base.load[width=1](in_batch_base + 60)
            var rr0_lane1 = p.input_real_base.load[width=1](in_batch_base + 75)
            var ii0_lane1 = p.input_imag_base.load[width=1](in_batch_base + 75)
            var rr0_lane2 = p.input_real_base.load[width=1](in_batch_base + 90)
            var ii0_lane2 = p.input_imag_base.load[width=1](in_batch_base + 90)
            var rr0_lane3 = p.input_real_base.load[width=1](in_batch_base + 105)
            var ii0_lane3 = p.input_imag_base.load[width=1](in_batch_base + 105)
            var rr0 = SIMD[DType.float32, 4](rr0_lane0[0], rr0_lane1[0], rr0_lane2[0], rr0_lane3[0])
            var ii0 = SIMD[DType.float32, 4](ii0_lane0[0], ii0_lane1[0], ii0_lane2[0], ii0_lane3[0])
            var rr1_lane0 = p.input_real_base.load[width=1](in_batch_base + 300)
            var ii1_lane0 = p.input_imag_base.load[width=1](in_batch_base + 300)
            var rr1_lane1 = p.input_real_base.load[width=1](in_batch_base + 315)
            var ii1_lane1 = p.input_imag_base.load[width=1](in_batch_base + 315)
            var rr1_lane2 = p.input_real_base.load[width=1](in_batch_base + 330)
            var ii1_lane2 = p.input_imag_base.load[width=1](in_batch_base + 330)
            var rr1_lane3 = p.input_real_base.load[width=1](in_batch_base + 345)
            var ii1_lane3 = p.input_imag_base.load[width=1](in_batch_base + 345)
            var rr1 = SIMD[DType.float32, 4](rr1_lane0[0], rr1_lane1[0], rr1_lane2[0], rr1_lane3[0])
            var ii1 = SIMD[DType.float32, 4](ii1_lane0[0], ii1_lane1[0], ii1_lane2[0], ii1_lane3[0])
            var rr2_lane0 = p.input_real_base.load[width=1](in_batch_base + 540)
            var ii2_lane0 = p.input_imag_base.load[width=1](in_batch_base + 540)
            var rr2_lane1 = p.input_real_base.load[width=1](in_batch_base + 555)
            var ii2_lane1 = p.input_imag_base.load[width=1](in_batch_base + 555)
            var rr2_lane2 = p.input_real_base.load[width=1](in_batch_base + 570)
            var ii2_lane2 = p.input_imag_base.load[width=1](in_batch_base + 570)
            var rr2_lane3 = p.input_real_base.load[width=1](in_batch_base + 585)
            var ii2_lane3 = p.input_imag_base.load[width=1](in_batch_base + 585)
            var rr2 = SIMD[DType.float32, 4](rr2_lane0[0], rr2_lane1[0], rr2_lane2[0], rr2_lane3[0])
            var ii2 = SIMD[DType.float32, 4](ii2_lane0[0], ii2_lane1[0], ii2_lane2[0], ii2_lane3[0])
            var rr3_lane0 = p.input_real_base.load[width=1](in_batch_base + 780)
            var ii3_lane0 = p.input_imag_base.load[width=1](in_batch_base + 780)
            var rr3_lane1 = p.input_real_base.load[width=1](in_batch_base + 795)
            var ii3_lane1 = p.input_imag_base.load[width=1](in_batch_base + 795)
            var rr3_lane2 = p.input_real_base.load[width=1](in_batch_base + 810)
            var ii3_lane2 = p.input_imag_base.load[width=1](in_batch_base + 810)
            var rr3_lane3 = p.input_real_base.load[width=1](in_batch_base + 825)
            var ii3_lane3 = p.input_imag_base.load[width=1](in_batch_base + 825)
            var rr3 = SIMD[DType.float32, 4](rr3_lane0[0], rr3_lane1[0], rr3_lane2[0], rr3_lane3[0])
            var ii3 = SIMD[DType.float32, 4](ii3_lane0[0], ii3_lane1[0], ii3_lane2[0], ii3_lane3[0])
            ...
            var or3 = oa1r - ob1i
            var oi3 = oa1i + ob1r
            FFTFP32Kernel0.buf_a.store(spad_base + 16, or0[0])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 16, oi0[0])
            FFTFP32Kernel0.buf_a.store(spad_base + 20, or0[1])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 20, oi0[1])
            FFTFP32Kernel0.buf_a.store(spad_base + 24, or0[2])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 24, oi0[2])
            FFTFP32Kernel0.buf_a.store(spad_base + 28, or0[3])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 28, oi0[3])
            ...
            or1 = tr1
            oi1 = ti1
            FFTFP32Kernel0.buf_a.store(spad_base + 17, or1[0])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 17, oi1[0])
            FFTFP32Kernel0.buf_a.store(spad_base + 21, or1[1])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 21, oi1[1])
            FFTFP32Kernel0.buf_a.store(spad_base + 25, or1[2])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 25, oi1[2])
            FFTFP32Kernel0.buf_a.store(spad_base + 29, or1[3])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 29, oi1[3])
            ...
            or2 = tr2
            oi2 = ti2
            FFTFP32Kernel0.buf_a.store(spad_base + 18, or2[0])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 18, oi2[0])
            FFTFP32Kernel0.buf_a.store(spad_base + 22, or2[1])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 22, oi2[1])
            FFTFP32Kernel0.buf_a.store(spad_base + 26, or2[2])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 26, oi2[2])
            FFTFP32Kernel0.buf_a.store(spad_base + 30, or2[3])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 30, oi2[3])
            ...
            or3 = tr3
            oi3 = ti3
            FFTFP32Kernel0.buf_a.store(spad_base + 19, or3[0])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 19, oi3[0])
            FFTFP32Kernel0.buf_a.store(spad_base + 23, or3[1])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 23, oi3[1])
            FFTFP32Kernel0.buf_a.store(spad_base + 27, or3[2])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 27, oi3[2])
            FFTFP32Kernel0.buf_a.store(spad_base + 31, or3[3])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 31, oi3[3])
        ...
        if True:  # batch 3 scope
            ...
            var rr0_lane0 = p.input_real_base.load[width=1](in_batch_base + 180)
            var ii0_lane0 = p.input_imag_base.load[width=1](in_batch_base + 180)
            var rr0_lane1 = p.input_real_base.load[width=1](in_batch_base + 195)
            var ii0_lane1 = p.input_imag_base.load[width=1](in_batch_base + 195)
            var rr0_lane2 = p.input_real_base.load[width=1](in_batch_base + 210)
            var ii0_lane2 = p.input_imag_base.load[width=1](in_batch_base + 210)
            var rr0_lane3 = p.input_real_base.load[width=1](in_batch_base + 225)
            var ii0_lane3 = p.input_imag_base.load[width=1](in_batch_base + 225)
            var rr0 = SIMD[DType.float32, 4](rr0_lane0[0], rr0_lane1[0], rr0_lane2[0], rr0_lane3[0])
            var ii0 = SIMD[DType.float32, 4](ii0_lane0[0], ii0_lane1[0], ii0_lane2[0], ii0_lane3[0])
            var rr1_lane0 = p.input_real_base.load[width=1](in_batch_base + 420)
            var ii1_lane0 = p.input_imag_base.load[width=1](in_batch_base + 420)
            var rr1_lane1 = p.input_real_base.load[width=1](in_batch_base + 435)
            var ii1_lane1 = p.input_imag_base.load[width=1](in_batch_base + 435)
            var rr1_lane2 = p.input_real_base.load[width=1](in_batch_base + 450)
            var ii1_lane2 = p.input_imag_base.load[width=1](in_batch_base + 450)
            var rr1_lane3 = p.input_real_base.load[width=1](in_batch_base + 465)
            var ii1_lane3 = p.input_imag_base.load[width=1](in_batch_base + 465)
            var rr1 = SIMD[DType.float32, 4](rr1_lane0[0], rr1_lane1[0], rr1_lane2[0], rr1_lane3[0])
            var ii1 = SIMD[DType.float32, 4](ii1_lane0[0], ii1_lane1[0], ii1_lane2[0], ii1_lane3[0])
            var rr2_lane0 = p.input_real_base.load[width=1](in_batch_base + 660)
            var ii2_lane0 = p.input_imag_base.load[width=1](in_batch_base + 660)
            var rr2_lane1 = p.input_real_base.load[width=1](in_batch_base + 675)
            var ii2_lane1 = p.input_imag_base.load[width=1](in_batch_base + 675)
            var rr2_lane2 = p.input_real_base.load[width=1](in_batch_base + 690)
            var ii2_lane2 = p.input_imag_base.load[width=1](in_batch_base + 690)
            var rr2_lane3 = p.input_real_base.load[width=1](in_batch_base + 705)
            var ii2_lane3 = p.input_imag_base.load[width=1](in_batch_base + 705)
            var rr2 = SIMD[DType.float32, 4](rr2_lane0[0], rr2_lane1[0], rr2_lane2[0], rr2_lane3[0])
            var ii2 = SIMD[DType.float32, 4](ii2_lane0[0], ii2_lane1[0], ii2_lane2[0], ii2_lane3[0])
            var rr3_lane0 = p.input_real_base.load[width=1](in_batch_base + 900)
            var ii3_lane0 = p.input_imag_base.load[width=1](in_batch_base + 900)
            var rr3_lane1 = p.input_real_base.load[width=1](in_batch_base + 915)
            var ii3_lane1 = p.input_imag_base.load[width=1](in_batch_base + 915)
            var rr3_lane2 = p.input_real_base.load[width=1](in_batch_base + 930)
            var ii3_lane2 = p.input_imag_base.load[width=1](in_batch_base + 930)
            var rr3_lane3 = p.input_real_base.load[width=1](in_batch_base + 945)
            var ii3_lane3 = p.input_imag_base.load[width=1](in_batch_base + 945)
            var rr3 = SIMD[DType.float32, 4](rr3_lane0[0], rr3_lane1[0], rr3_lane2[0], rr3_lane3[0])
            var ii3 = SIMD[DType.float32, 4](ii3_lane0[0], ii3_lane1[0], ii3_lane2[0], ii3_lane3[0])
            ...
            var or3 = oa1r - ob1i
            var oi3 = oa1i + ob1r
            FFTFP32Kernel0.buf_a.store(spad_base + 48, or0[0])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 48, oi0[0])
            FFTFP32Kernel0.buf_a.store(spad_base + 52, or0[1])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 52, oi0[1])
            FFTFP32Kernel0.buf_a.store(spad_base + 56, or0[2])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 56, oi0[2])
            FFTFP32Kernel0.buf_a.store(spad_base + 60, or0[3])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 60, oi0[3])
            ...
            or1 = tr1
            oi1 = ti1
            FFTFP32Kernel0.buf_a.store(spad_base + 49, or1[0])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 49, oi1[0])
            FFTFP32Kernel0.buf_a.store(spad_base + 53, or1[1])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 53, oi1[1])
            FFTFP32Kernel0.buf_a.store(spad_base + 57, or1[2])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 57, oi1[2])
            FFTFP32Kernel0.buf_a.store(spad_base + 61, or1[3])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 61, oi1[3])
            ...
            or2 = tr2
            oi2 = ti2
            FFTFP32Kernel0.buf_a.store(spad_base + 50, or2[0])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 50, oi2[0])
            FFTFP32Kernel0.buf_a.store(spad_base + 54, or2[1])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 54, oi2[1])
            FFTFP32Kernel0.buf_a.store(spad_base + 58, or2[2])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 58, oi2[2])
            FFTFP32Kernel0.buf_a.store(spad_base + 62, or2[3])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 62, oi2[3])
            ...
            or3 = tr3
            oi3 = ti3
            FFTFP32Kernel0.buf_a.store(spad_base + 51, or3[0])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 51, oi3[0])
            FFTFP32Kernel0.buf_a.store(spad_base + 55, or3[1])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 55, oi3[1])
            FFTFP32Kernel0.buf_a.store(spad_base + 59, or3[2])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 59, oi3[2])
            FFTFP32Kernel0.buf_a.store(spad_base + 63, or3[3])
            FFTFP32Kernel0.buf_a.store(spad_base + N + 63, oi3[3])
    ...
    def stage_1():
        ...
        if True:  # batch 0 scope
            ...
            var rr1 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 16)
            var ii1 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 16)
            var rr2 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 32)
            var ii2 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 32)
            var rr3 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 48)
            var ii3 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 48)
        ...
        if True:  # batch 1 scope
            ...
            var rr0 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 4)
            var ii0 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 4)
            var rr1 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 20)
            var ii1 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 20)
            var rr2 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 36)
            var ii2 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 36)
            var rr3 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 52)
            var ii3 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 52)
            ...
            var or3 = oa1r - ob1i
            var oi3 = oa1i + ob1r
            FFTFP32Kernel0.buf_b.store(spad_base + 16, or0[0])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 16, oi0[0])
            FFTFP32Kernel0.buf_b.store(spad_base + 17, or0[1])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 17, oi0[1])
            FFTFP32Kernel0.buf_b.store(spad_base + 18, or0[2])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 18, oi0[2])
            FFTFP32Kernel0.buf_b.store(spad_base + 19, or0[3])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 19, oi0[3])
            ...
            or1 = tr1
            oi1 = ti1
            FFTFP32Kernel0.buf_b.store(spad_base + 20, or1[0])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 20, oi1[0])
            FFTFP32Kernel0.buf_b.store(spad_base + 21, or1[1])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 21, oi1[1])
            FFTFP32Kernel0.buf_b.store(spad_base + 22, or1[2])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 22, oi1[2])
            FFTFP32Kernel0.buf_b.store(spad_base + 23, or1[3])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 23, oi1[3])
            ...
            or2 = tr2
            oi2 = ti2
            FFTFP32Kernel0.buf_b.store(spad_base + 24, or2[0])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 24, oi2[0])
            FFTFP32Kernel0.buf_b.store(spad_base + 25, or2[1])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 25, oi2[1])
            FFTFP32Kernel0.buf_b.store(spad_base + 26, or2[2])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 26, oi2[2])
            FFTFP32Kernel0.buf_b.store(spad_base + 27, or2[3])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 27, oi2[3])
            ...
            or3 = tr3
            oi3 = ti3
            FFTFP32Kernel0.buf_b.store(spad_base + 28, or3[0])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 28, oi3[0])
            FFTFP32Kernel0.buf_b.store(spad_base + 29, or3[1])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 29, oi3[1])
            FFTFP32Kernel0.buf_b.store(spad_base + 30, or3[2])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 30, oi3[2])
            FFTFP32Kernel0.buf_b.store(spad_base + 31, or3[3])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 31, oi3[3])


        if True:  # batch 2 scope
            # ===== stage 1, SIMD batch 2 (valid lanes: 4/4) =====
            var rr0 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 8)
            var ii0 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 8)
            var rr1 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 24)
            var ii1 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 24)
            var rr2 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 40)
            var ii2 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 40)
            var rr3 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 56)
            var ii3 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 56)
        ...
        if True:  # batch 3 scope
            ...
            var rr0 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 12)
            var ii0 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 12)
            var rr1 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 28)
            var ii1 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 28)
            var rr2 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 44)
            var ii2 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 44)
            var rr3 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + 60)
            var ii3 = FFTFP32Kernel0.buf_a.load[DType.float32, 4](spad_base + N + 60)
            ...
            var or3 = oa1r - ob1i
            var oi3 = oa1i + ob1r
            FFTFP32Kernel0.buf_b.store(spad_base + 48, or0[0])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 48, oi0[0])
            FFTFP32Kernel0.buf_b.store(spad_base + 49, or0[1])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 49, oi0[1])
            FFTFP32Kernel0.buf_b.store(spad_base + 50, or0[2])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 50, oi0[2])
            FFTFP32Kernel0.buf_b.store(spad_base + 51, or0[3])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 51, oi0[3])
            ...
            or1 = tr1
            oi1 = ti1
            FFTFP32Kernel0.buf_b.store(spad_base + 52, or1[0])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 52, oi1[0])
            FFTFP32Kernel0.buf_b.store(spad_base + 53, or1[1])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 53, oi1[1])
            FFTFP32Kernel0.buf_b.store(spad_base + 54, or1[2])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 54, oi1[2])
            FFTFP32Kernel0.buf_b.store(spad_base + 55, or1[3])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 55, oi1[3])
            ...
            or2 = tr2
            oi2 = ti2
            FFTFP32Kernel0.buf_b.store(spad_base + 56, or2[0])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 56, oi2[0])
            FFTFP32Kernel0.buf_b.store(spad_base + 57, or2[1])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 57, oi2[1])
            FFTFP32Kernel0.buf_b.store(spad_base + 58, or2[2])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 58, oi2[2])
            FFTFP32Kernel0.buf_b.store(spad_base + 59, or2[3])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 59, oi2[3])
            ...
            or3 = tr3
            oi3 = ti3
            FFTFP32Kernel0.buf_b.store(spad_base + 60, or3[0])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 60, oi3[0])
            FFTFP32Kernel0.buf_b.store(spad_base + 61, or3[1])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 61, oi3[1])
            FFTFP32Kernel0.buf_b.store(spad_base + 62, or3[2])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 62, oi3[2])
            FFTFP32Kernel0.buf_b.store(spad_base + 63, or3[3])
            FFTFP32Kernel0.buf_b.store(spad_base + N + 63, oi3[3])
    ...
    def stage_2():
        ...
        if True:  # batch 0 scope
            ...
            var rr1 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 16)
            var ii1 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 16)
            var rr2 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 32)
            var ii2 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 32)
            var rr3 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 48)
            var ii3 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 48)
            ...
            var ltwr1 = p.large_twiddle_real_base.load[width=4](out_batch_base + 16)
            var ltwi1 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 16)
            ...
            var ltwr2 = p.large_twiddle_real_base.load[width=4](out_batch_base + 32)
            var ltwi2 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 32)
            ...
            var ltwr3 = p.large_twiddle_real_base.load[width=4](out_batch_base + 48)
            var ltwi3 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 48)
        ...
        if True:  # batch 1 scope
            ...
            var rr0 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 4)
            var ii0 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 4)
            var rr1 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 20)
            var ii1 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 20)
            var rr2 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 36)
            var ii2 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 36)
            var rr3 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 52)
            var ii3 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 52)
            ...
            var or3 = oa1r - ob1i
            var oi3 = oa1i + ob1r
            var ltwr0 = p.large_twiddle_real_base.load[width=4](out_batch_base + 4)
            var ltwi0 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 4)
            var ltr0 = or0 * ltwr0 - oi0 * ltwi0
            var lti0 = or0 * ltwi0 + oi0 * ltwr0
            or0 = ltr0
            oi0 = lti0
            ...
            var ltwr1 = p.large_twiddle_real_base.load[width=4](out_batch_base + 20)
            var ltwi1 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 20)
            var ltr1 = or1 * ltwr1 - oi1 * ltwi1
            var lti1 = or1 * ltwi1 + oi1 * ltwr1
            or1 = ltr1
            oi1 = lti1
            ...
            var ltwr2 = p.large_twiddle_real_base.load[width=4](out_batch_base + 36)
            var ltwi2 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 36)
            var ltr2 = or2 * ltwr2 - oi2 * ltwi2
            var lti2 = or2 * ltwi2 + oi2 * ltwr2
            or2 = ltr2
            oi2 = lti2
            ...
            var ltwr3 = p.large_twiddle_real_base.load[width=4](out_batch_base + 52)
            var ltwi3 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 52)
            var ltr3 = or3 * ltwr3 - oi3 * ltwi3
            var lti3 = or3 * ltwi3 + oi3 * ltwr3
            or3 = ltr3
            oi3 = lti3
        ...
        if True:  # batch 2 scope
            ...
            var rr0 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 8)
            var ii0 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 8)
            var rr1 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 24)
            var ii1 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 24)
            var rr2 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 40)
            var ii2 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 40)
            var rr3 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 56)
            var ii3 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 56)
            ...
            var or3 = oa1r - ob1i
            var oi3 = oa1i + ob1r
            var ltwr0 = p.large_twiddle_real_base.load[width=4](out_batch_base + 8)
            var ltwi0 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 8)
            var ltr0 = or0 * ltwr0 - oi0 * ltwi0
            var lti0 = or0 * ltwi0 + oi0 * ltwr0
            or0 = ltr0
            oi0 = lti0
            ...
            var ltwr1 = p.large_twiddle_real_base.load[width=4](out_batch_base + 24)
            var ltwi1 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 24)
            var ltr1 = or1 * ltwr1 - oi1 * ltwi1
            var lti1 = or1 * ltwi1 + oi1 * ltwr1
            or1 = ltr1
            oi1 = lti1
            ...
            var ltwr2 = p.large_twiddle_real_base.load[width=4](out_batch_base + 40)
            var ltwi2 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 40)
            var ltr2 = or2 * ltwr2 - oi2 * ltwi2
            var lti2 = or2 * ltwi2 + oi2 * ltwr2
            or2 = ltr2
            oi2 = lti2
            ...
            var ltwr3 = p.large_twiddle_real_base.load[width=4](out_batch_base + 56)
            var ltwi3 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 56)
            var ltr3 = or3 * ltwr3 - oi3 * ltwi3
            var lti3 = or3 * ltwi3 + oi3 * ltwr3
            or3 = ltr3
            oi3 = lti3
        ...
        if True:  # batch 3 scope
            ...
            var rr0 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 12)
            var ii0 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 12)
            var rr1 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 28)
            var ii1 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 28)
            var rr2 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 44)
            var ii2 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 44)
            var rr3 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + 60)
            var ii3 = FFTFP32Kernel0.buf_b.load[DType.float32, 4](spad_base + N + 60)
            ...
            var or3 = oa1r - ob1i
            var oi3 = oa1i + ob1r
            var ltwr0 = p.large_twiddle_real_base.load[width=4](out_batch_base + 12)
            var ltwi0 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 12)
            var ltr0 = or0 * ltwr0 - oi0 * ltwi0
            var lti0 = or0 * ltwi0 + oi0 * ltwr0
            or0 = ltr0
            oi0 = lti0
            ...
            var ltwr1 = p.large_twiddle_real_base.load[width=4](out_batch_base + 28)
            var ltwi1 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 28)
            var ltr1 = or1 * ltwr1 - oi1 * ltwi1
            var lti1 = or1 * ltwi1 + oi1 * ltwr1
            or1 = ltr1
            oi1 = lti1
            ...
            var ltwr2 = p.large_twiddle_real_base.load[width=4](out_batch_base + 44)
            var ltwi2 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 44)
            var ltr2 = or2 * ltwr2 - oi2 * ltwi2
            var lti2 = or2 * ltwi2 + oi2 * ltwr2
            or2 = ltr2
            oi2 = lti2
            ...
            var ltwr3 = p.large_twiddle_real_base.load[width=4](out_batch_base + 60)
            var ltwi3 = p.large_twiddle_imag_base.load[width=4](out_batch_base + 60)
            var ltr3 = or3 * ltwr3 - oi3 * ltwi3
            var lti3 = or3 * ltwi3 + oi3 * ltwr3
            or3 = ltr3
            oi3 = lti3
...
struct FFTFP32Kernel1(NDPTask):
    ...
    def stage_0():
        ...
        # ===== stage 0, SIMD batch 0 (valid lanes: 1/4) =====
        var rr0_lane0 = p.input_real_base.load[width=1](in_batch_base + 0)
        var ii0_lane0 = p.input_imag_base.load[width=1](in_batch_base + 0)
        ...
        var ltwr0 = SIMD[DType.float32, 4](ltwr0_lane0[0], Float32(1), Float32(1), Float32(1))
        var ltwi0 = SIMD[DType.float32, 4](ltwi0_lane0[0], Float32(0), Float32(0), Float32(0))
        var ltr0 = or0 * ltwr0 - oi0 * ltwi0
        var lti0 = or0 * ltwi0 + oi0 * ltwr0
        or0 = ltr0
        oi0 = lti0
        ...
        var ltwr1 = SIMD[DType.float32, 4](ltwr1_lane0[0], Float32(1), Float32(1), Float32(1))
        var ltwi1 = SIMD[DType.float32, 4](ltwi1_lane0[0], Float32(0), Float32(0), Float32(0))
        var ltr1 = or1 * ltwr1 - oi1 * ltwi1
        var lti1 = or1 * ltwi1 + oi1 * ltwr1
        or1 = ltr1
        oi1 = lti1
        ...
        var ltwr2 = SIMD[DType.float32, 4](ltwr2_lane0[0], Float32(1), Float32(1), Float32(1))
        var ltwi2 = SIMD[DType.float32, 4](ltwi2_lane0[0], Float32(0), Float32(0), Float32(0))
        var ltr2 = or2 * ltwr2 - oi2 * ltwi2
        var lti2 = or2 * ltwi2 + oi2 * ltwr2
        or2 = ltr2
        oi2 = lti2
...
struct FFTFP32Kernel2(NDPTask):
    ...
    def stage_0():
        ...
        var rr3 = SIMD[DType.float32, 4](rr3_lane0[0], Float32(0), Float32(0), Float32(0))
        var ii3 = SIMD[DType.float32, 4](ii3_lane0[0], Float32(0), Float32(0), Float32(0))
        ...
        var rr4 = SIMD[DType.float32, 4](rr4_lane0[0], Float32(0), Float32(0), Float32(0))
        var ii4 = SIMD[DType.float32, 4](ii4_lane0[0], Float32(0), Float32(0), Float32(0))
